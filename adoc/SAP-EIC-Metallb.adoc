...
A complete overview and more details about {metallb} can be found at https://metallb.universe.tf/[official website for {metallb}].

=== Prerequisites

Before starting the installation, ensure that all requirements are met. In particular, you should pay attention to network add-on compatibility.
...
There are several ways to deploy {metallb}. In this guide, we describe how to use the {rac} to deploy {metallb}.
