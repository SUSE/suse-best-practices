...
_Guest:_ Any support guest OS footnote:anysupportedos[Any OS that is supported for the use with {sapphirerapids} and SAP HANA may be used as guest OS.]  

_Size:_ max. 4 sockets footnote:max4sockets, 4 TiB RAM
|
_Hypervisor:_ {sles4sapAbbr} 15 SP5 

_Guest:_ Any support guest OS footnote:anysupportedos 
