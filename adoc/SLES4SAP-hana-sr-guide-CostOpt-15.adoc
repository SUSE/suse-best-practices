...
it is recommended to register your systems to either a local SUSE Manager, to the Subscription Manangement Tool (SMT), 
...
https://documentation.suse.com/de-de/sles/15-SP1/html/SLES-all/pre-rmt.html
