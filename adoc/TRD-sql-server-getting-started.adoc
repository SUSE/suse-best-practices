...
=== Loading Sample Data
Microsoft has provided some https://github.com/microsoft/sql-server-samples[sample databases] you can utilize to seed your mssql instance with some data. 
...
[source,bash]
----
curl https://github.com/Microsoft/sql-server-samples/releases/download/wide-world-importers-v1.0/WideWorldImporters-Full.bak /tmp/WideWorldImporters-Full.bak
----
...
Project 10 table names from `WideWorldImporters` database.
