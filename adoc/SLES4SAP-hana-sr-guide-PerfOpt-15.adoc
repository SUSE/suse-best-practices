...
// defining article ID
[#art-sap-hana-srguide-perfopt15]

// Load document variables
include::Var_SLES4SAP-hana-classic-scaleup-perfopt-15.txt[]
include::Var_SLES4SAP-hana-classic-scaleup-perfopt-15-param.txt[]
//
...
The here described HA setup using the SAPHanaSR package has been used in the past.
It still is supported for existing clusters.
For deploying new HA clusters, we recommend to use the SAPHanaSR-angi package
following 
"{SAPHANA} System Replication Scale-Up - Performance Optimized Scenario".
// TODO PRIO1: add URL once published
// (https://documentation.suse.com/sbp/sap-15/html/SLES4SAP-hana-angi-perfopt-15).
...
// DO NOT CHANGE SECTION ID: refer to Trento checks 61451E and 438525
...
parallel to susChkSrv.py, if not documented otherwise.
...
// DO NOT CHANGE SECTION ID: refer to Trento check D028B9
[[cha.hana-sr.scope]]
...
// DO NOT CHANGE SECTION ID: refer to Trento check CAEFF1
...
// DO NOT CHANGE SECTION TITLE as this would change autogenerated section ID
// Refer to Trento checks 31BDCB, 53D33E, 82A031, DF8328
...
// DO NOT CHANGE SECTION ID: refer to Trento check ABA3CA
...
// DO NOT CHANGE SECTION ID:  refer to Trento check 0B0F87
[[cha.s4s.hana-hook]]
== {stepHook}
...
==========
Best is to use the {HANA} tools for changing global.ini. Alternatively you may use
...
Cmnd_Alias HOOK_HELPER  = /usr/sbin/SAPHanaSR-hookHelper --sid={refsid} --case=checkTakeover
...
As user {refsidadm} check the {HANA} tracefiles, if SAPHanaSR.py did successfully interact with the cluster or created a fallback file.
...
As user {refsidadm} check the {HANA} tracefiles, if susTkOver.py did successfully blocked or permitted the takeover request.
...
In case a hardware watchdog is used, a desired action is predefined after the timeout
of the watchdog has reached. If your watchdog module is loaded and not controlled by any
other application, do the following:
...
// DO NOT CHANGE SECTION TITLE as this would change autogenerated section ID
// Refer to Trento checks 32CFC6, 7E0221, DA114A
...
// DO NOT CHANGE SECTION TITLE as this would change autogenerated section ID
// Refer to Trento checks 0B6DB2 and 49591F
...
// DO NOT CHANGE SECTION TITLE as this would change autogenerated section ID
// Refer to Trento checks 205AF7, 373DB8, B089BE
...
.{testProc}
.  Crash the secondary site node (currently primary {HANA}) by sending a 'fast-reboot' system request.
+
[subs="attributes,quotes"]
----
...
// DO NOT CHANGE SECTION TITLE as this would change autogenerated section ID
// Refer to Trento checks 00081D, 156F64, 15F7A8, 21FCA6, 24ABCB, 32CFC6, 33403D, 53D035, 6E9B82
// Refer to Trento checks 7E0221, 822E47, 845CC9, A1244C, C620DC, D78671, DA114A, FB0E0D, BA215C
