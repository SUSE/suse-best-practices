...
you can use _visudo_ to start the vi editor for the */etc/sudoers.d/SAPHanaSR*
configuration file.
...
communication between {saphana} and the cluster, you can start the {saphana}
databases on both sites.
...
// TODO PRIO2: align check with manual page SAPHanaSrMultiTarget.py(7)
