...
The shown Filesystem and SAPInstance monitor timeouts are a trade-off between
fast recovery vs. resilience against sporadic temporary NFS issues. You may
slightly increase it to fit your infrastructure.
The SAPInstance timeout needs to be higher than the Filesystem timeout.
Please consult your storage or NFS server documentation for appropriate
timeout values.
...
fast recovery vs. resilience against sporadic temporary NFS issues. You may
slightly increase it to fit your infrastructure.
The Filesystem timeout needs to be higher than the Filesystem timeout.
Please consult your storage or NFS server documentation for appropriate
timeout values.
See also manual pages ocf_heartbeat_Filesystem(7), ocf_heartbeat_SAPInstance(7)
and nfs(5).
