...
Backup your system configuration and all data to be able to switch back to the current configuration.

.Minimum recommended list of "objects" to be backed-up externally
