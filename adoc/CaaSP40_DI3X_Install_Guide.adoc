...
SAP Data Intelligence 3 is a tool that makes dealing with these amounts of data more easy and SUSE delivers with SUSE CaaS Platform 4 the foundation to run SAP Data Intelligence 3 on top of it.

== Requirements

In order to install SAP Data Intelligence 3 on SUSE CaaS Platform 4 we need to meet certain requirements:
...
The minimum hardware requirements for installing SAP Data Intelligence 3 on premise are for production use:
...
- 2 Cores
- 16 GiB RAM
- Diskspace: 80 GiB for /, including the space for the SAP Data Intelligence 3 software and at least 100 GiB for /var/lib/docker (needed for the SAP Data Intelligence 3 installation)
...
** N.B. For SAP Data Hub it is required to stay on SUSE CaaS Platform 4.0.x, x=0,1,2,3 because of the Kubernetes version delivered with our CaaSP product. SAP Data Intelligence 3 needs Kubernetes version not higher than 1.15.
...
Description of the preparation and installation of SAP Data Intelligence 3 on SUSE CaaS Platform 4 Cluster
...
Go to SAP Software Download Center, login with your SAP account and search for SAP DATA Intelligence 3 or access this link.
...
Create a new namespace in the Kubernetes cluster to install SAP Data Intelligence 3 into:
...
SAP recommends this approach to install SAP Data Intelligence 3
...
Run the install command as described in SAP Data Intelligence 3 install guide, https://help.sap,com/datahub
...
SAP Data Intelligence 3 installation on premise require SUSE Enterprise Storage 5 or higher.
