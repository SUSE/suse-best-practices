...
For the latest SUSE product documentation updates, see https://www.suse.com/documentation.
...
After the `ssh-keygeer`, the `ssh-keygen` is set up and you will have two new files under `/root/.ssh/`.
