...
The storage sizing depends on many indicators. Check the sizing recommendations for the planed use case.
...
IMPORTANT: The Fault Manger is enhanced to work in this setup. The minimal versions which support this scenario are
