...
To avoid creating identical imagePullSecrets in multiple namespaces, you can also introduce a registry in your cluster config.
...
Once opened, click on _Show Advanced_ as displayed in the picture below:
...
3. Once the resources are successfully applied, return to this guide to complete the following steps.
...
Refer to <<raDownloadKubeconfig>> for the detailed steps and visual guides. Once downloaded, you can provide this file to the {elm} UI to finish initializing your Edge Node.
