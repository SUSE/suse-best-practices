...
// = {title}
= MongoDB with SUSE Rancher: A Technical Quick Looks
...
== Motivation
This is the motivation for what we are saying: https://documentation.suse.com/external-tree/en-us/suma/4.1/suse-manager/index.html[SUSE Manager].  let's get to the bottom of this.
