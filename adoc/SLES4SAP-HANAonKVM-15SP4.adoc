...
*Hardware vulnerabilities mitigations (mitigations=auto kvm.nx_huge_pages=off tsx=off)*
...
*KVM PLE-GAP (kvm_intel.ple_gap=0 kvm_intel.ple_window=0)*
...
*Processor C-states (intel_idle.max_cstate=0)*
