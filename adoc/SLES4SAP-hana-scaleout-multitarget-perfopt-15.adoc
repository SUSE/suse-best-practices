...
| -------- | ------ | .. --------- | --------- | .. --------- | .. ------
| SYSTEMDB | hanaso0 | .. {sapsite1}      | hanaso2  | .. {sapsite2}      | .. **ACTIVE**
| {sapsid}      | hanaso0 | .. {sapsite1}      | hanaso2  | .. {sapsite2}      | .. **ACTIVE**
| {sapsid}      | hanaso0 | .. {sapsite1}      | hanaso2  | .. {sapsite2}      | .. **ACTIVE**
| {sapsid}      | hanaso1 | .. {sapsite1}      | hanaso3  | .. {sapsite2}      | .. **ACTIVE**
...
[subs="specialchars,attributes"]
----
~> hdbnsutil -sr_register --name={sapsite3} --remoteHost=hanaso0 --remoteInstance=00 --replicationMode=async --operationMode=logreplay
----
...
----------------------------------------
{sapsite3}                         SOK        
{sapsite2}  30         4   hanaso2 SOK    S   
{sapsite1}  1657838665 4   hanaso0 PRIM   P   

Hosts   clone_state gra gsh node_state roles                        score  site 
--------------------------------------------------------------------------------
hanamm                      online                                             
hanaso0 PROMOTED    2.0 2.2 online     master1:master:worker:master 150    {sapsite1} 
hanaso1 DEMOTED     2.0 2.2 online     slave:slave:worker:slave     -10000 {sapsite1} 
hanaso2 DEMOTED     2.0 2.2 online     master1:master:worker:master 100    {sapsite2} 
hanaso3 DEMOTED     2.0 2.2 online     slave:slave:worker:slave     -12200 {sapsite2} 
...
Active Resources:
  ...
  * rsc_ip_{sapsid}_HDB{sapino}    (ocf::heartbeat:IPaddr2):        Started hanaso0
----
