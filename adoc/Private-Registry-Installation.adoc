...
----
+
Note that you can use distinct Service Accounts for each Harbor component. Read link:https://kubernetes.io/docs/concepts/policy/pod-security-policy/[upstream documentation] to find out more about Pod Security Policies.
