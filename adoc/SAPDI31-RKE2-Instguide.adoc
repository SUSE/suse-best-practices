...
Only the x86_64 architecture is applicable for our use case.
...
* via the informations in the release notes of the SLC Bridge at https://launchpad.support.sap.com/#/notes/2589449.
...
Go to the Maintenance Planner at https://apps.support.sap.com/sap/support/mp published on SAP site 
...
The table below lists some of the parameters available for an SAP DI 3.1 installation:
...
This section provides some tips what should and could be done to maintain the Kubernetes cluster, 
...
the installations must be registered either to SUSE Customer Center or a SMT/RMT server or SUSE Manager with a valid subscription.
...
* Read section https://docs.rke2.io/upgrade/basic_upgrade/[Upgrade Basics] of the RKE 2 documentation.

* Create a backup of everything. 

* Block access to SAP DI.

* Run the update of RKE 2 according to the https://docs.rke2.io/upgrade/basic_upgrade/[RKE 2 documentation].
