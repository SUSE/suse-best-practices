...
Assign role _administration host_ to your installation.
...
Once nodes have reboot, log in and finish network/host name and NTP configurations so that
...
You could now proceed to Section 4.1.2 of this documentation and follow the instructions detailled in "Prerequisites on the SUSE CaaS Platform 3 Cluster" 
