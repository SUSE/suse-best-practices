...
How to create the *imagePullSecret* is described in the Section xref:SAP_Edge_Integration_cell.adoc#imagePullSecret[].

===== Create Secret with certificates
Second we need to create the Kubernetes secret with the certificates. You will find an example how to to dis in the xref:SAP_Edge_Integration_cell.adoc#Appendix[].
