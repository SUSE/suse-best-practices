...
nfsrv:/s/{mySid}/cz /usr/sap/{mySid} nfs4 rw,noac,sync,default 0 0
...
[subs="specialchars,attributes"]
----
# mkdir -p /usr/sap/{mySid}/.check /usr/sap/.check_{mySid}
----
...
Find below a typical mzadmin users ~/bashrc file. 
