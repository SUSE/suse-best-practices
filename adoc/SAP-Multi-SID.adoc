...
* check / modify the ASCS and ERS profile files and add the section for the {s4sClConnector3} integration, if not done already 
...
=== Example ENSA1 in a Multi Node Cluster
=== Example ENSA2 in a Multi Node Cluster
This base setup is already documented in our *Best Practice* for {s4Hana}
(https://documentation.suse.com/sbp/all -> {sap} {sapS4} - Enqueue Replication 2 High Availability Cluster - Setup Guide).
...
INFO: Under observation. Please send an e-mail to saphana@suse.com if this might be interesting for you.
