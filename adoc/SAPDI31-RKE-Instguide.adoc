...
//TODO Kevin: SWAP config, disable
...
* configure disks in the ui of longhorn
//FIXME Screenshots

** access the UI of Longhorn:

image::longhorn_dashboard.png["Longhorn UI Overview", 480, 640]

image::longhorn_dash_nodes.png["Longhorn UI Nodes" , 480, 640]

image::longhorn_dash_nodes_edit.png["Longhorn UI Edit node", 480, 640]

image::longhorn_dash_add_disk1.png[Longhorn UI Add disk, 480, 640]

image::longhorn_dash_disk2.png[Longhorn UI disk save, 480, 640]
...
The following command creates a storageclass named longhorn.
