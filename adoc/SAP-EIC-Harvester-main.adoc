...
NOTE: The installation of {reg} is not a mandatory requirement for the deployment of {eic} and is thereby optional. If you want to continue without using a {reg}, please continue with the next chapter <<installDatabases>>.
