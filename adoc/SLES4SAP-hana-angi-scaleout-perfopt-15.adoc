...
for SUSE Linux Enterprise High Availability at https://documentation.suse.com/sle-ha/15-SP4/single-html/SLE-HA-install-quick/#sec-ha-inst-quick-bootstrap.
...
/hana/shared/<SID>. The RA monitors the file system but does not mount nor
