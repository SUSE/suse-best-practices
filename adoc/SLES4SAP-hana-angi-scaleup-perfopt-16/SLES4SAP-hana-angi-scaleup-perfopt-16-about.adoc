...
{SUSE} is accommodating the customers by offering {sles4sap},
...
solutions for customers to ensure the high availability of {HANA} data bases.
...
From the application perspective, the following variations are covered:
...
From the infrastructure perspective, the following scenario variations are covered:
...
done with {SAPHanaSR} only. For upgrading existing clusters to {SAPHanaSR},
