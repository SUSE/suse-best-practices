...
To use two corosync rings make sure your have two interfaces configured and run:
...
Administration Guide for {sleha} {pn15} {psp15} at {haAdminGuide15}#cha-ha-manual-config.
...
\\ TODO secondary IP resource + constraints
