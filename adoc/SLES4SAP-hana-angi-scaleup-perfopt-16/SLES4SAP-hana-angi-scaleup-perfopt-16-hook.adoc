...
script, see also SAPHanaSR-manageProvider(8). For details about the progressive
configuration see manual page SAPHanaSR-angi-scenarios(7).
...
==== Check loading of the hook scripts
