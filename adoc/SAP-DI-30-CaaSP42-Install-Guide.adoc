...
TIP: This step is optional if you already have a storage that provides rbd volumes and/or S3 buckets. If you do skip this chapter and follow the instructions at <<SUSE Enterprise Storage>>
