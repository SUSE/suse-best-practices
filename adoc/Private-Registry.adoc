...
include::Private-Registry-Scenarios.adoc[Supported Deployment Scenarios]

include::Private-Registry-Features.adoc[Supported Features]
...
include::Private-Registry-Glossary.adoc[Glossary]
