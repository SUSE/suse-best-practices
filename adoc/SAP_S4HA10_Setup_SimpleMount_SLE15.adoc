...
XFS is used for all local file systems. For _/sapmnt/SID_ and _/usr/sap/SID_ NFS is used.
...
The disk {myDevB} for the database (260GB) is assigned to {myNode1} and formatted with XFS.
