...
|4
|{HANA} database is up and OK. The cluster interprets this as a correctly running
database.
...
intention, this triggers a takeover.
...
The following complete crm progressive configuration is for a two-node cluster
