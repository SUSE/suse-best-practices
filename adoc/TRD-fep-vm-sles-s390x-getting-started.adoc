...
. Go to the hostname or IP address and port number of the FEP WebAdmin server: http://<hostname or IP address>:27515
...
Virtualization Cookbook for IBM Z Volume 5: KVM (An IBM Redbooks publication)[https://www.redbooks.ibm.com/abstracts/sg248463.html?Open].
