...
NOTE: If you update from a {sapS4Pl} version less then 1809, please read SAP Note 2641019 carefully to adapt your cluster.
...
The task list to setup the three node cluster is similar to the task list of the two node cluster. But some
...
.Check for valid DNS, time synchronisation, network settings
==========
...
////
//  BLOCKED SAP SWPM INFO TILL AVAILABILITY IN SEPTEMBER 2019-06-19
