...
image::images/src/jpg/TRD_SLES-SAP-HA-automation-quickstart-cloud-s3-bucket.jpg[width=470]
...
image::images/src/jpg/TRD_SLES-SAP-HA-automation-quickstart-cloud-s3-bucket-aws-automation-complete[width=470]
