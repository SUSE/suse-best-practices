...
This guide describes the on-premises installation of {di} {di_version} on top of {vmw} vSphere/vSAN cluster and Rancher Kubernetes Engine (RKE) 2. This guide does not provide information on how to setup a {vmw} vsphere / vsan cluster.
...
* Create the configuration of the vsphere CPI/CSI drivers for the use with RKE 2
