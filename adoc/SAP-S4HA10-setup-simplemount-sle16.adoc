...
NOTE: The cluster described in this guide only manages the {sap} instances ASCS and ERS.
...
interface is used for the knet communication (eth1). The option *-S* is special
