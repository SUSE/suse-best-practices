...
Implement two {hana} HA/DR provider hook scripts. SAPHanaSR.py needs no config
parameters. susCostOpt.py needs to be adapted according to your specific system
...
----
# su - {refsidadm}
~> hdbuserstore SET saphanasr_{refsid}_costopt localhost:31013 SYSTEM SuSE1234
