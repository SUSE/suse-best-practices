...
Take a note of the service port of the SLCBridge. It is needed for the installation of SAP DI 3.1 or re-configuring DI 3.1, e.g. enabling backup.
...
** SAP Data Intelligence 3 can be configured to create regular backups. See //FIXME link to help.sap.com
...
// FIXME give an example order of commands
