...
For additional information on the new simple mount architecture, please cf.
...
will remain supported for the lifetime of {sles4sap} {slesProdVersion}.
...
// TODO PRIO3: remove master-slave
// TODO PRIO3: compare to Filesystem-based
...
////
TODO PRIO3: add the end if needed
