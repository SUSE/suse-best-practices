...
This guide focuses on the high availability of the central services. For high
availabiliy of the {saphana} database, consult the guide for the scale-up
performance-optimized scenario (see <<sec.resource>>).
