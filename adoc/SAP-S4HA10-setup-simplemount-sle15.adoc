...
----
================================================
The shown SAPInstance monitor timeout is a trade-off between fast fail-over vs.
resilience against sporadic temporary NFS issues. You may slightly increase it
