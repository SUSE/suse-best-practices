...
==== Maintenance procedure for Linux cluster or system with ASCS and ERS instances remain running
...
Let the Linux cluster detect status of the ASCS and ERS resources:
