...
image::rancher-mongo-1.png[scaledwidth=50%]
...
image::rancher-mongo-2.png[scaledwidth=50%]
...
image::rancher-mongo-3.png[scaledwidth=50%]
...
image::rancher-mongo-4.png[scaledwidth=50%]
