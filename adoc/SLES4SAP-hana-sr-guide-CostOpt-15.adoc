...
* corosync (two rings, or one ring in exceptional cases)
* HAWK Web interface
...
After the setup of the corosync configuration and the SBD parameters, start the cluster again (`{clusterstart}`).
