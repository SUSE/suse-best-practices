...
// TODO PRIO1: re-registering neccessary for cativating name server changes?
// TODO PRIO2: detailled command example for above change
...
----
hanaso0:~ # SAPHanaSR-showAttr 
Global cib-time                 maintenance prim sec  sync_state topology 
--------------------------------------------------------------------------
TST    Fri Jul 15 00:44:25 2022 false       WDF1 ROT1 SOK        ScaleOut
