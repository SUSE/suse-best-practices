...
* see Rancher RKE 2 documentation 
...
* See Rancher RKE 2 documentation https://rancher.com/docs/rke/latest/en/upgrades/

* Download the version of RKE 2 that fits your needs and uses a Kubernetes version that is compatible with SAP DI 3.1
