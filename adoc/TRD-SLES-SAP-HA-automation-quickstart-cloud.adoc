...
:cloud: AWS
:firstname: Stephen
:surname: Mogg, Public Cloud Solutions Architect, SUSE
endif::[]

ifdef::GCP[]
:cloud: GCP
:firstname: Abdelrahman
:surname: Mohamed, Public Cloud Solutions Architect - Google Alliance, SUSE
endif::[]
...
ifeval::[ "{cloud}" == "AWS" ]
----
hana_inst_master = "s3://mysapmedia"

hana_archive_file = "s4hana1809HANA/{hana_archive_version}.exe"
----
