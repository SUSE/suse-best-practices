...
More guides and best practices documents referring to SUSE Linux Enterprise Server and {sap} are available 
for download on the SUSE Best Practices Web pages:
