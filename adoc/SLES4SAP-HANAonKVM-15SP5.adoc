...
:sapPortal: https://launchpad.support.sap.com/#/notes/
...
This is the OS running SAP HANA and therefore the one that should be checked for SAP HANA support as per {sapPortal}2235581[SAP Note 2235581 "SAP HANA: Supported Operating Systems"] and the https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/["`SAP HANA Hardware Directory`"].
...
_Size:_ max. 2 sockets{max4sockets}, 4 TiB RAM
|
_Hypervisor:_ {sles4sapAbbr} 15 SP5 
...
* {sapPortal}2284516[SAP Note 2284516 - "SAP HANA virtualized on SUSE Linux Enterprise Hypervisors"]
* {sapPortal}3538596[SAP Note 3538596 - "SAP HANA on SUSE KVM Virtualization with SLES 15 SP5"]
...
* fulfill the SAP HANA Hardware and Cloud Measurement Tools (HCMT) storage KPI's as per {sapPortal}2493172[SAP Note 2493172 "SAP HANA Hardware and Cloud Measurement Tools"]. 
...
This is described in {sapPortal}1522993[SAP Note 1522993 - "Linux: SAP on SUSE KVM - Kernel-based Virtual Machine"].
...
For details on HCMT, refer to {sapPortal}2493172[SAP Note 2493172 - "SAP HANA Cloud and Hardware Measurement Tools"].
...
You can use either a vbd disk or a virtio-serial device (preferred) to set this up (see {sapPortal}1522993[SAP Note 1522993 - "Linux: SAP on SUSE KVM - Kernel-based Virtual Machine"] for details).
...
* {sapPortal}1944799[SAP Note 1944799 - "SAP HANA Guidelines for SLES Operating System Installation"]
* {sapPortal}2684254[SAP Note 2684254 - "SAP HANA DB: Recommended OS settings for SLES 15 / SLES for SAP applications 15"]
...
{sapPortal}1522993[SAP Note 1522993 - "Linux: SAP on SUSE KVM - Kernel-based Virtual Machine"] describes how to set up the virtual devices for `vhostmd` and how to configure it.
...
* {sapPortal}2284516[SAP Note 2284516 - "SAP HANA virtualized on SUSE Linux Enterprise Hypervisors"]
* {sapPortal}1944799[SAP Note 1944799 - "SAP HANA Guidelines for SLES Operating System Installation"]
* {sapPortal}2684254[SAP Note 2684254 - "SAP HANA DB: Recommended OS settings for SLES 15 / SLES for SAP"] 
* {sapPortal}1522993[SAP Note 1522993 - "Linux: SAP on SUSE KVM - Kernel-based Virtual Machine"]
