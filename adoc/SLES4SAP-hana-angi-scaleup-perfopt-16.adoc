...
to the {haAdminGuide16} on detailed explanations of the terms unicast/multicast.
...
Cluster Summary:
  * Stack: corosync
  * Current DC: {sapnode1} (version 3.0.0+20241202.ba59be712-160000.4.16.1-2.0.5) - partition with quorum
  * Last updated: Thu Jun 10 08:32:58 2025
  * Last change:  Thu Jun 10 08:29:41 2025 by hacluster via crmd on {sapnode1}
  * 2 nodes configured
...
Full List of Resources:
  * stonith-sbd	(stonith:fence_sbd):	 Started {sapnode1}
----
...
Availability at {haAdminGuide16}. For public cloud environments, refer to your cloud provider's documentation on supported fencing mechanisms.
