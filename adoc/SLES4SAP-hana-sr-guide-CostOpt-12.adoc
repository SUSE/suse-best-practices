...
lots of Unix-to-Linux and Windows-to-Linux migrations. {SUSE} is also
accommodating this development by providing {sles4sap} – the recommended and supported operating system
for {SAPHANA}. In close collaboration with {SAP}, cloud service and
hardware partners, {SUSE} defines scenarios for customers to ensure the
high availability of {SAPHANA} system replications.
...
"SAP HANA Scale-Up System Replication Cost Optimized".
...
// TODO PRIO1: CostOpt12 - Describe Cost optimized not performance optimized scenario !!
...
is the main disadvantage of the cost optimization scenario.
...
////
// TODO: TO BE DELETED
// TODO PRIO1: CostOpt12 - Check, if we can use this comment-out-part
...
// TODO PRIO1: CostOpt12: scope to be adopted to CostOpt (not PerfOpt)
...
// TODO PRIO1: CostOpt12 - Should we add a step for CostOpt (install non-productive DB) at this level or should we 'hide' the step in 'stepHANA'?
...
// TODO PRIO1: CostOpt12 - do we need to increase the requirements? How much?
