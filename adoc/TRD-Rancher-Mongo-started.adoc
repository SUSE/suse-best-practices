...
image::../images/Replication.png[title=replication,scaledwidth=50%]
...
image::../images/image001.png[title=Rancher architecture,scaledwidth=50%]
...
image::../images/image003.png[title=MongoDB architecture,scaledwidth=50%]
