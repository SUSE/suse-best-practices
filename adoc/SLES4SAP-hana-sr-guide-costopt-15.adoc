...
hook script is `susChkSrv.py`. For installation details please refer to manual
page susChkSrv.py(7).
...
the HA/DR hook scripts during start. Alternatively, SAPHanaSR-manageProfile might
be used for adapting the global.ini.
See manual page SAPHanaSR-manageProfile(8) for details.
...
script, see also SAPHanaSR-manageProfile(8).
