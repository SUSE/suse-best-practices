...
// TODO PRIO2: ?? will remain supported for the lifetime of {sles4sap} {slesProdVersion}.
...
(https://documentation.suse.com/sbp/all/html/SAP_S4HA10_SetupGuide_SimpleMount-SLE15).
