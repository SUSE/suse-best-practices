...
Prerequistes: A failed former primary sites has just been manually registered. The exact site name has been used as already known to the cluster, see parameter sheet.
...
different command line tools for cluster status requests. Please see manual pages
