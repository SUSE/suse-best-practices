...
// begin AWS
* The AWS STONITH mechanism supported by SLE 15 HAE is supported with SAPHanaSR.
...
Availability Zone 1 is "A" and Availability Zone 2 is "B", installed on two  SLES for SAP 15 SP1 systems.
...
-	Two Availability Zones within a Region to be selected for the SAP HANA cluster implementation
...
{lauchPadNotes}2578899
2684254 - SAP HANA DB: Recommended OS settings for SLES 15 / SLES for SAP Applications 15::
{lauchPadNotes}2684254
...
=== Appendix: Checklist - SUSE Cluster Setup in AWS
