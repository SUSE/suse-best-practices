...
// == SAP S/4 HANA 1809 High Availability Cluster With Simple Mount

// Fabian Herschel, Bernd Schubert, Thomas Korber
// 2021/11/17
...
the SUSE Linux Enterprise High Availability cluster. A third node is used for
...
= SAP S/4 HANA - Enqueue Replication 2 High Availability Cluster With Simple Mount - Setup Guide
// == SAP S/4 HANA 1909 High Availability Cluster With Simple Mount
