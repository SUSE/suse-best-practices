...
(see also manual page cs_wait_for_idle(8)).
...
At 15:02:11 (UTC) The secondary score is decreded: score="-INFINITY".

At 15:02:14 (UTC) The secondary is also marked as in error (lss="1"). The cluster jumped-in and initiated a restart for the failed secondary.

At 15:03:09 (UTC) The seconary is marked as back (lss="4") and the system replication is up again (srHook="SOK").

At 15:03:10 (UTC) The seconary score is set back again to 100.
