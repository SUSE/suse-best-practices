...
Multi-Target replication. Because of the mandatory chain toplogy, the RA
...
A Multi-Tier system replication has an additional target, which is connected to
...
Please find concept and implementation details in manual page
...
.{SAPHANA} Cockpit – Landscape of a scale-out system
