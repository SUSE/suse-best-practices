...
include::Var_SLES4SAP-hana-angi-scaleup-perfopt-16.txt[]
include::Var_SLES4SAP-hana-angi-scaleup-perfopt-16-param.txt[]
//
...
To create this document, {sles4sap} {prodNr} {prodMinor} was used. However, the concept can also be
...
{sles4sapa} {prodnr} {prodminor} systems.
