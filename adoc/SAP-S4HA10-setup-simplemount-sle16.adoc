...
>>>>>>> SLES4SAP-hana-angi-scaleup-perfopt-16-tmp
...
include::SAP-S4HA10-setup-simplemount-sle16-about.adoc[]

include::SAP-S4HA10-setup-simplemount-sle16-scope.adoc[]

include::SAP-S4HA10-setup-simplemount-sle16-overview.adoc[]

include::SAP-S4HA10-setup-simplemount-sle16-sap.adoc[]

include::SAP-S4HA10-setup-simplemount-sle16-cluster.adoc[]

include::SAP-S4HA10-setup-simplemount-sle16-multinode.adoc[]

include::SAP-S4HA10-setup-simplemount-sle16-administration.adoc[]

include::SAP-S4HA10-setup-simplemount-sle16-references.adoc[]

include::SAP-S4HAinclude::10-setup-simplemount-sle16-appendix.adoc[]

include::SAP-S4HA10-setup-simplemount-sle16-legal.adoc[]
=======
//
...
ASCS is installed on the first cluster node, ERS is installed on the second. To integrate ASCS and ERS on all cluster node
to systemd the SAP instances need to be registered on the nodes.

On the first cluster node ERS needs to be registred, on the second cluster node ASCS needs to be registered.
...
After the registration it could be that the service is still enabled. The next section describes how to
disable the SAP<sid>_<ino> services.
