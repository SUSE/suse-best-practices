...
for SBD might be an iSCSI target placed at the cluster third site. The SBD
devices are accessed from all five cluster nodes. But the block devices devices
are backed  by storage outside the cluster.
