...
system replication cluster installed on two sites based on {sles4sap} 15 SP1.
This concept can also be used with {sles4sap} 15 GA or newer.
...
of a {sle} High Availability Extension 15 cluster. It gathers information about the statuses and
...
* Automated start of {SAPHANA} instances during system boot must be switched
  *off*.
* You need at least SAPHanaSR-ScaleOut version 0.161, {sles4sap} 15 SP1 and
...
(https://documentation.suse.com/sles/15-SP1/html/SLES-all/book-sle-deployment.html).
...
Operating system tuning are described in SAP note 1275776 and 2684254.
...
https://documentation.suse.com/sles/15-SP1/single-html/SLES-storage/
