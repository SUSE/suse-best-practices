...
https://documentation.suse.com/releasenotes/sles/16.{prodMinor}/index.html#v160-kernel-limits
SUSE Linux Enterprise file system specs::
https://documentation.suse.com/releasenotes/sles/16.{prodMinor}/index.html#file-system-comparison
...
- SAPHanaSR-showStatus(8)
// - SAPHanaSR-show-hadr-runtimes(8)
- SAPHanaSR_with_DR_HA(7)
- SAPHanaSR_with_DR_HA_setup(7)
- saptune(8)
- sbd(8)
- stonith_sbd(7)
- sudo(8)
...
What are SAPHanaSR-angi configuration variants?::
 https://www.suse.com/c/what-are-saphanasr-angi-configuration-variants/
...
SUSE HA for SAP HANA scale-up cost-optimized improved::
 https://www.suse.com/c/suse-ha-for-sap-hana-scale-up-cost-optimized-improved/
