...
File _/usr/sap/{mySid}/SYS/profile/{mySid}_{myInstAscs}_{myVipNAscs}_:
...
File _/usr/sap/{mySid}/SYS/profile/{mySid}_{myInstErs}_{myVipNErs}_:

[subs="attributes"]
----
Start_Program_00 = local $(_ENQR) pf=$(_PF) NR=$(SCSID)
----
// T_DO PRIO2: Check if the variable is _PF or _PFL
...
https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions[SAP HANA Hardware Directory]
