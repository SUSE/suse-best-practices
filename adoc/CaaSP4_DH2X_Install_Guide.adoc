...
//- SUSE Linux Enterprise Server 12 SP4 or SUSE Linux Enterprise Server 15 SP1 (or even openSUSE Leap 15.X)
- 2 Cores
- 16 GiB RAM
...
haproxy is available in the SLE HA Extension.

* Install SLE 15 SP1

* add SLE 15 SP1 HA repository
...
This is a web-based installation method recommended by SAP offering you an option to send analytics data and feedback to SAP. All the necessary prerequisites have been satisfied by applying all the steps described above.
