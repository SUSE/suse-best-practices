...
indicators. Check the supported configurations on
...
- After both nodes listed in the overview, verify the property setting of the basic cluster configuration. 
...
the multi-state construct anymore and to move to a more cluster-like construct to
...
- Settup the first property file for a smoke test.
...
Next is how to *clean up resource failures*. Failures of the ASCS will be automatically
