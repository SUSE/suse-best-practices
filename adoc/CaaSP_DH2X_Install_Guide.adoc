...
Kubernetes master is running at https://spwdfvml2054.wdf.sap.corp:6443
Dex is running at https://spwdfvml2054.wdf.sap.corp:6443/api/v1/namespaces/kube-system/services/dex:dex/proxy
KubeDNS is running at https://spwdfvml2054.wdf.sap.corp:6443/api/v1/namespaces/kube-system/services/kube-dns:dns/proxy
kubernetes-dashboard is running at https://spwdfvml2054.wdf.sap.corp:6443/api/v1/namespaces/kube-system/services/https:kubernetes-dashboard:https/proxy
Tiller is running at https://spwdfvml2054.wdf.sap.corp:6443/api/v1/namespaces/kube-system/services/tiller:tiller/proxy
