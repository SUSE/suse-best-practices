...
The following picture shows the landscape overview:
...
In this document we'll guide you through the installation for the required clusters.
...
If you're deploying {metallb}, {redis} and {pg} as described in this guide, you'll need to create the imagePullSecret in the related namespaces,
which means, you'll have three secrets with the same content but in three different namespaces.
