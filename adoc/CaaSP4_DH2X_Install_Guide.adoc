...
image::portus-registry.png[title="Setting the registry in Portus",scaledwidth=95%]
...
or have a SMT/RMT properly set up and already mirroring these products:
...
+
image::scc-sle.png[title="SUSE Customer Center: Overview SLE",scaledwidth=99%]
...
** SMT
+
image::scc-ses.png[title="SUSE Customer Center: SMT",scaledwidth=99%]
...
+
image::multi-s-smt.png[title="Multiple Nodes on SMT View",scaledwidth=95%]
...
+
image::openattic-dash.png[title="SUSE Enterprise Storage WebUI",scaledwidth=95%]
...
+
image::openattic-rbd.png[title="Providing Access to Pool",scaledwidth=90%]
