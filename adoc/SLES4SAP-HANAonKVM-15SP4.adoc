...
For example, if the host has 6339943304 KiB (that is, 6 TiB) of memory and we want to leave 91.75% of it to the hypervisor (see <<_sec_memory_sizing>>), and there are 4 NUMA cells, each NUMA cell will have the following number of huge pages:
...
* Memory
** The hypervisor has 6 TiB RAM (or 6144 GiB), of which 5544 GiB has been allocated as 1 GB huge pages and therefore 5544 GiB is the max VM size in this case
