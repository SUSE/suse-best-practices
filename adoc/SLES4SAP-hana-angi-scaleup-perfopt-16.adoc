...
// TODO PRIO2: replace {SAPHana} by correct RA vaiable
...
down by intention, this triggers a takeover.

|0 |Internal Script Error. Database status unknown. Cluster action depends
on RA parameter ON_FAIL_ACTION.
|=======================================================================
