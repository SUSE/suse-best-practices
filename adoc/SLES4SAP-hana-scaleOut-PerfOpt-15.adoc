...
include::Var_SLES4SAP-hana-classic-scaleout-perfopt-15.txt[]
include::Var_SLES4SAP-hana-classic-scaleout-perfopt-15-param.txt[]
:docinfo:
...
└─SAP{sapsid}_{sapino}.service
  ...
  ├─31372 /usr/sap/{sapsid}/HDB{sapino}/{sapnode1}/trace/hdb.sap{sapsid}_HDB{sapino} -d -nw -f /usr/sap/{sapsid}/HDB{sapino}/suse21/daemon.ini pf=/usr/sap/{sapsid}/SYS/profile/{sapsid}_HDB{sapino}_{sapnode2}
  ├─31479 hdbnameserver
...
// rsync -va {,suse02:}/usr/sap/{sapsid}/SYS/global/security/rsecssfs/data/SSFS_{sapsid}.DAT
// rsync -va {,suse02:}/usr/sap/{sapsid}/SYS/global/security/rsecssfs/key/SSFS_{sapsid}.KEY
...
| {sapsid}      | suse01 | .. WDF1      | suse02    | .. ROT1      | .. **ACTIVE**
| {sapsid}      | suse01 | .. WDF1      | suse02    | .. ROT1      | .. **ACTIVE**
| {sapsid}      | suse03 | .. WDF1      | suse04    | .. ROT1      | .. **ACTIVE**
| {sapsid}      | suse05 | .. WDF1      | suse06    | .. ROT1      | .. **ACTIVE**
...
...
Beside these parameters, the timeout values for the operations (start, monitor,
...
**{mySite1FirstNode}**:{mySapAdm}> /usr/sap/hostctrl/exe/saphostctrl -function ListInstances
 Inst Info : {sapsid} - {sapino} - **{mySite1FirstNode}** - 749, patch 418, changelist 1816226
----
==========
...
------------------------------------------------------------
{sapsid}    Tue Jun 12 15:02:58 2021 {mySite1Name} {mySite2Name} SOK
