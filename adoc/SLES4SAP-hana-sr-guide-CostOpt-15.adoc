...
at https://documentation.suse.com/sles-sap/15-SP1/single-html/SLES4SAP-guide/#cha-s4s-cluster.
// TODO PRIO3: use variables for URL
...
// TODO PRIO3: use variable for note's number
...
_Adding the Second Node_ of the Installation and Setup Quick Start for SUSE Linux Enterprise High Availability Extension 15.
...
for SUSE Linux Enterprise High Availability Extension 15, and the TIDs 7016880 and 7008216.
// TODO PRIO3: use variable
...
https://documentation.suse.com/sle-ha/15-SP1/html/SLE-HA-all/cha-ha-storage-protect.html#pro-ha-storage-protect-fencing).
...
it is recommended to register your systems to either a local SUSE Manager, to {rmtool} ({rmt}), 
...
https://documentation.suse.com/sles/15-SP1/html/SLES-all/pre-rmt.html
...
https://documentation.suse.com/sle-ha/15-SP1/html/SLE-HA-all/cha-ha-migration.html
//TODO PRIO3: use variable
...
Storage Administration Guide for {sls} 15::
 https://documentation.suse.com/sles/15-SP1/single-html/SLES-storage/#stor-admin
