...
scale-up package.
* {sap} HANA 2.0 SPS04 or later provides the HA/DR provider hook method preTakeover().
...
Ideally two rings would be used.
Review the SUSE product documentation about details and about
additional rings. See also manual pages corosync.conf(5) and
votequorum(5).
