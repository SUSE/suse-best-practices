...
NOTE: For this scenario, the latest version of the {s4sClConnector3} is used.
...
use it. Make sure to use the correct virtual host name for each installation step.
