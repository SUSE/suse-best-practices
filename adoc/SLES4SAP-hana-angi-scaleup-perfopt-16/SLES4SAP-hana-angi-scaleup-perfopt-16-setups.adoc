...
[[cha.hana-sr.setups]]
== Supported setups and prerequisites
...
// TODO PRIO1: What is the minimum SAP HANA version on SLE16?
...
* If susChkSrv.py parameter action_on_lost=stop is set and the RA {SAPHanaRA}
