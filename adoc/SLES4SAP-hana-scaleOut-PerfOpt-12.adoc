...
[IMPORTANT]
====
Automated registration of a failed primary after takeover is not possible
with SAPHanaSR-ScaleOut version 0.161.
...
of restarting the failed primary locally. Set to *false* for SAPHanaSR-ScaleOut.

|AUTOMATED_REGISTER
|Defines whether a former primary should be automatically registered to be
secondary of the new primary. Set to *false* for SAPHanaSR-ScaleOut version 0.161.
