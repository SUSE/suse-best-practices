...
For an overview of supported scenarios see also section <<Scale-Up Scenarios and Resource Agents>>.
...
- public cloud deployment (usually needs additional documentaion focusing on the cloud specific implementation details)
...
* Install the non-replicated {HANA} with memeory limits
