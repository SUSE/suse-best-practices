...
For more information, see section _Installation and Basic Setup_ of the {uarr}{suselinux} {sleha} guide.
...
They *must* be tuned to your environment. Please refer to the 
...
Cluster Summary:
  ...
  * Last change:  Thu Jun 10 08:29:41 2021 by hacluster via crmd on {sapnode01}
  * 2 nodes configured
  * 1 resource instance configured

Node List:
  * Online: [ {sapnode01} {sapnode02}  ]

Full List of Resources:
  * stonith-sbd	(stonith:external/sbd):	 Started {sapnode01}
----
