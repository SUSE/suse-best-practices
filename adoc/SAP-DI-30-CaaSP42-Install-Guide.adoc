...
Last mentionable file is *data_volume: /data* which defines where all your Harbor data is going to. If you want Harbor to store the data somewhere else, enter the path to the desired directory here.
