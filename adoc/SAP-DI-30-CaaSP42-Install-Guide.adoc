...
You now will see the *Installation Settings* page, where you need to disable the firewall. You can achive this by clicking the *disable* button after *Firewall will be enabled*.
...
//TODO this is always printed in the background of the followed picture
...
//TODO remove when done with the upper part
...
** link:https://documentation.suse.com/ses/6/html/ses-all/ceph-install-saltstack.html#ceph-install-stack[Wipe disk]
...
All these tasks are run from the management workstation.
