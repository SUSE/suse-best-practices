= SAP NetWeaver Enqueue Replication 1 High Availability Cluster - Setup Guide for SAP NetWeaver 7.40 and 7.50 - SLE15
:slesProdVersion: 15
...
- {myNfsSrv}:{bsNFSExpPathSapMedia750} /sapcd
...
version 3. New features like SAP Rolling Kernel Switch (RKS) and move of ASCS are
...
----
Stack: corosync
urrent DC: {myNode1} (version 1.1.18+20180430.b12c320f5-1.14-b12c320f5) - partition with quorum
...
- After both nodes listed in the overview please verify the property setting of the basic cluster configuration. Very important here is the setting: *record-pending=true*. 
