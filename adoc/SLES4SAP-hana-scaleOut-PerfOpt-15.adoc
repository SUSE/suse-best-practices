...
- 3-site cluster with diskbased and diskless SBD fencing
- 1-site cluster with diskbased and diskless SBD fencing
...
* The cluster must include a valid STONITH method.
  SBD diskbased or diskless is recommended STONITH method.
...
storage location. Please find more details and exmaples in manual page
