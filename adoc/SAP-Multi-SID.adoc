...
.Configuration Example for SID a 4th SID and following, for example {sid4}
====
...
The setup here is simular to that what is done in the chapter <<Example ENSA1 and ENSA2 in a Two-Node Cluster>> but only with more nodes in the cluster.
