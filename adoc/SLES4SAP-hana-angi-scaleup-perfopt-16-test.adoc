...
=== Test cases for full automation - conservative variant

In the following test descriptions we assume
*PREFER_SITE_TAKEOVER="true"* and *AUTOMATED_REGISTER="true".*

The resource agents and HA/DR hooks are configured for the conservative variant.
...
=== Test cases for full automation - progressive variant
