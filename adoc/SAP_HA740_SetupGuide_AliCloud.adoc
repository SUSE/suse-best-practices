...
The installation media are normaly store in a central place which can be mounted from all node which need the software. 
We normaly mount this share or export  to */sapcd*.
