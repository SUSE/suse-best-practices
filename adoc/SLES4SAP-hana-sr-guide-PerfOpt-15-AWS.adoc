...
The setting _poweroff_ forces the EC2 STONITH agent to shut down the EC2 instance in case of fencing operation. 
...
{testComp}::
  Cluster node of secondary site
{testDescr}::
  Simulate a crash of the secondary site node running the seconday HANA database.
...
detailled in section _Upgrading Your Cluster and Updating Software Packages_ of the
