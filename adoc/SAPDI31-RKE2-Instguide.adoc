...
* section https://docs.rke2.io/upgrade/basic_upgrade/[Ugrade Basics] of the RKE 2 documentation.
...
* Run the update of RKE 2 according to the https://docs.rke2.io/upgrade/basic_upgrade/[RKE 2 documentation, section Upgrade Basics].
